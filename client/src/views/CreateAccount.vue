<template>
  <v-container>
    ...
    <!--  tabs -->
    <v-card>
      <v-tabs background-color="blue-grey lighten-5" color="indigo" grow>
        <v-tab>
        ...
        <v-tab-item>
          <v-card text>
            <v-form ref="form" v-model="valid" lazy-validation>
              ...
              <v-btn class="ma-6 success" @click="submit" :disabled="!valid">
                Register
              </v-btn>
            </v-form>
          </v-card>
        ...
        <v-tab-item>
          ...
          <v-card text>
            <v-form ref="form" v-model="valid" lazy-validation>
              ...
              ></v-select>
              <v-select
                :items="['Meberat Haile', 'Kidane Mihret']"
                label="Branch"
                class="ma-6"
                v-model="branch"
              ></v-select>
              ...
              <v-text-field
                ...
                required
              ></v-text-field>
              <v-btn class="ma-6 success" @click="submit2" :disabled="!valid">
                Register
              </v-btn>
            </v-form>
          </v-card>
